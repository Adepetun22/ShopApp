  ...
  return (
    <div className="flex flex-col gap-3 xs:gap-2 sm:gap-4 items-start justify-start flex-shrink-0 w-full relative">
      ...
      <div className="flex flex-col gap-1.5 xs:gap-1 sm:gap-2 items-start justify-start self-stretch flex-shrink-0 relative w-full">
        ...
        <div className="flex flex-row gap-2 xs:gap-1.5 sm:gap-3.5 items-center justify-start flex-shrink-0 relative">
        ...
        <div className="flex flex-row gap-2 xs:gap-1.5 sm:gap-2.5 items-center justify-start flex-shrink-0 relative flex-wrap">
          ...
          {originalPrice && (
            <>
              ...
              {discount && (
                <div className="bg-red-500 bg-opacity-10 rounded-[3rem] xs:rounded-[2rem] sm:rounded-[3.875rem] py-1 xs:py-0.5 sm:py-1.5 px-2 xs:px-1.5 sm:px-3.5 flex flex-row gap-2 xs:gap-1 sm:gap-3 items-center justify-center flex-shrink-0 w-[2.5rem] xs:w-[2rem] sm:w-[3.625rem] relative overflow-hidden">
